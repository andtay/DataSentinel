...
**Generated:** 2026-05-16T20:57:58.403278Z
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/character" \
```
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/characters" \
```
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/charactersByIds" \
```
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/location" \
```
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/locations" \
```
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/locationsByIds" \
```
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/episode" \
```
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/episodes" \
```
...
```bash
curl -X GET \
  "https://rickandmortyapi.com/graphql/query/episodesByIds" \
```
...
**Generated by DataSentinel** | 2026-05-16T20:57:58.403278Z