...
Generated: 2026-05-17T11:16:29.396945Z
API Version: 1.0.0
...
async def test_character_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/character",
...
async def test_characters_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/characters",
        json=mock_data.model_dump() if hasattr(mock_data, 'model_dump') else mock_data,
        status_code=200,
    )
...
async def test_characters_by_ids_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/charactersByIds",
        json=mock_data.model_dump() if hasattr(mock_data, 'model_dump') else mock_data,
        status_code=200,
    )
...
async def test_location_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/location",
        json=mock_data.model_dump() if hasattr(mock_data, 'model_dump') else mock_data,
        status_code=200,
    )
...
async def test_locations_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/locations",
        json=mock_data.model_dump() if hasattr(mock_data, 'model_dump') else mock_data,
        status_code=200,
    )
...
async def test_locations_by_ids_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/locationsByIds",
        json=mock_data.model_dump() if hasattr(mock_data, 'model_dump') else mock_data,
        status_code=200,
    )
...
async def test_episode_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/episode",
        json=mock_data.model_dump() if hasattr(mock_data, 'model_dump') else mock_data,
        status_code=200,
    )
...
async def test_episodes_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/episodes",
        json=mock_data.model_dump() if hasattr(mock_data, 'model_dump') else mock_data,
        status_code=200,
    )
...
async def test_episodes_by_ids_success(api_validator, httpx_mock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://rickandmortyapi.com/query/episodesByIds",
        json=mock_data.model_dump() if hasattr(mock_data, 'model_dump') else mock_data,
        status_code=200,
    )
